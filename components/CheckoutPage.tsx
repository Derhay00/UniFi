...
const CheckoutPage = () => {
  ...
  const [subtotal, setSubtotal] = useState(279.00); // Initial product price
  const [uiCareSelected, setUICareSelected] = useState(false); // UI Care checkbox state

  const productPrice = 279.00;
  ...
  return (
    <div className="w-[1050px] mx-auto my-8 px-4">
              ...
              <tr>
                <td className="px-6 py-4">
                  <div className="flex items-center">
                    ...
                    />
                    <div>
                      <p className="font-medium">Access Point U7 Pro Max</p>
                      <p className="text-sm text-gray-500">SKU: U7-Pro-Max-US</p>
                    </div>
                  </div>
                </td>
                <td className="px-6 py-4 text-right">$279.00</td>
      ...
      <div className="mt-6 flex justify-end">
        <div className="w-72 flex flex-col items-center"> {/* Center items within this container */}
